...
public class MQSourceTaskHeadersSchemasIT extends AbstractJMSContextIT {
    ...
    private String getHeaderAsString(final Headers headers, final String headerName) {
        // Replace first and last part of string that is "
        return getHeaderAsJson(headers, headerName).replaceAll("^\"|\"$", "");
    }
    ...
    private byte[] getHeaderDataAsBase64DecodedBytes(final Headers headers, final String headerName) {
        final String base64String = getHeaderAsString(headers, headerName);
    ...
    public void userDefinedIntProperty() throws Exception {
        ...
        assertThat(getHeaderSchemaType(headers, "intProp")).isEqualTo(Schema.Type.STRING);
    ...
    public void userDefinedLongProperty() throws Exception {
        ...
        assertThat(getHeaderSchemaType(headers, "longProp")).isEqualTo(Schema.Type.STRING);
    ...
    public void userDefinedFloatProperty() throws Exception {
        ...
        assertThat(getHeaderSchemaType(headers, "floatProp")).isEqualTo(Schema.Type.STRING);
    ...
    public void userDefinedDoubleProperty() throws Exception {
        ...
        assertThat(getHeaderSchemaType(headers, "doubleProp")).isEqualTo(Schema.Type.STRING);
    ...
    public void userDefinedBooleanProperty() throws Exception {
        ...
        assertThat(getHeaderSchemaType(headers, "boolProp")).isEqualTo(Schema.Type.STRING);
    ...
    public void userDefinedByteProperty() throws Exception {
        ...
        assertThat(getHeaderSchemaType(headers, "byteProp")).isEqualTo(Schema.Type.STRING);
    ...
    public void userDefinedShortProperty_schemaIsInt16() throws Exception {
        ...
        assertThat(getHeaderSchemaType(headers, "shortProp")).isEqualTo(Schema.Type.STRING);
    ...
    public void jmsxDeliveryCount() throws Exception {
        ...
        assertThat(getHeaderSchemaType(headers, JmsConstants.JMSX_DELIVERY_COUNT)).isEqualTo(Schema.Type.STRING);
    ...
    public void jmsxGroupSeq() throws Exception {
        ...
        assertThat(getHeaderSchemaType(headers, JmsConstants.JMSX_GROUPSEQ)).isEqualTo(Schema.Type.STRING);
    ...
    public void jmsIbmMsgType() throws Exception {
        ...
        assertThat(getHeaderSchemaType(headers, JmsConstants.JMS_IBM_MSGTYPE)).isEqualTo(Schema.Type.STRING);
    ...
    public void jmsIbmEncoding() throws Exception {
        ...
        assertThat(getHeaderSchemaType(headers, JmsConstants.JMS_IBM_ENCODING)).isEqualTo(Schema.Type.STRING);
    ...
    public void jmsIbmPutTime() throws Exception {
        ...
        assertThat(getHeaderAsString(headers, JmsConstants.JMS_IBM_PUTTIME)).isNotNull();
    }
    ...
    public void jmsIbmPutApplType() throws Exception {
        ...
        assertThat(getHeaderSchemaType(headers, JmsConstants.JMS_IBM_PUTAPPLTYPE)).isEqualTo(Schema.Type.STRING);
    ...
    public void jmsIbmMqmdPutApplName() throws Exception {
        ...
        assertThat(getHeaderAsString(headers, JmsConstants.JMS_IBM_MQMD_PUTAPPLNAME)).isNotNull();
    }
    ...
    public void jmsIbmMqmdPutTime() throws Exception {
        ...
        assertThat(getHeaderAsString(headers, JmsConstants.JMS_IBM_MQMD_PUTTIME)).isNotNull();
    }
    ...
    public void jmsIbmMqmdBackoutCount() throws Exception {
        ...
        assertThat(getHeaderSchemaType(headers, JmsConstants.JMS_IBM_MQMD_BACKOUTCOUNT)).isEqualTo(Schema.Type.STRING);
    ...
    public void jmsIbmMqmdPriority() throws Exception {
        ...
        assertThat(getHeaderSchemaType(headers, JmsConstants.JMS_IBM_MQMD_PRIORITY)).isEqualTo(Schema.Type.STRING);
    ...
    public void jmsIbmMqmdPersistence() throws Exception {
        ...
        assertThat(getHeaderSchemaType(headers, JmsConstants.JMS_IBM_MQMD_PERSISTENCE)).isEqualTo(Schema.Type.STRING);
    ...
    public void jmsIbmMqmdMsgType() throws Exception {
        ...
        assertThat(getHeaderSchemaType(headers, JmsConstants.JMS_IBM_MQMD_MSGTYPE)).isEqualTo(Schema.Type.STRING);
    ...
    public void jmsIbmMqmdEncoding() throws Exception {
        ...
        assertThat(getHeaderSchemaType(headers, JmsConstants.JMS_IBM_MQMD_ENCODING)).isEqualTo(Schema.Type.STRING);
    ...
    private byte[] getHeaderDataAsHexDecodedBytes(final Headers headers, final String headerName) {
        String hexString = getHeaderAsString(headers, headerName);
    ...
    /**
     * JMS_IBM_MQMD_MsgId is a 24-byte binary property; must arrive as Schema.BYTES.
     * JsonConverter serialises BYTES as a base-64 JSON string, so the wire form
     * must be a quoted string whose content decodes to exactly 24 bytes.
     */
    @Test
    public void jmsIbmMqmdMsgId() throws Exception {
        ...
        // JsonConverter(schemas.enable=false) serialises BYTES as a base-64 JSON string
        final byte[] msgID = getHeaderDataAsHexDecodedBytes(headers, JmsConstants.JMS_IBM_MQMD_MSGID);
        assertThat(msgID).isNotNull();
        assertThat(msgID).hasSize(24);
    }

    /**
     * JMS_IBM_MQMD_CorrelId is a 24-byte binary property; must arrive as Schema.BYTES.
     * The decoded bytes must equal the bytes set via setJMSCorrelationIDAsBytes().
     */
    @Test
    public void jmsIbmMqmdCorrelId() throws Exception {
        ...
        final byte[] msgID = getHeaderDataAsHexDecodedBytes(headers, JmsConstants.JMS_IBM_MQMD_CORRELID);
        assertThat(msgID).isNotNull();
        assertThat(msgID).isEqualTo(TEST_CORREL_ID);
    }
    ...
    public void jmsIbmMqmdAccountingToken() throws Exception {
        ...
        assertThat(getHeaderDataAsBase64DecodedBytes(headers, JmsConstants.JMS_IBM_MQMD_ACCOUNTINGTOKEN)).hasSize(32);
    }
